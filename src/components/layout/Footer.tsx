        ...
        <div className="grid gap-8 md:grid-cols-4">
          <div className="space-y-3">
            ...
            <p className="max-w-xs leading-6">
              An editorial marketplace for modern homes. Handpicked excellence
              for every room.
            </p>
          </div>

          <div>
            <h4 className="mb-3 text-[11px] font-bold uppercase tracking-widest text-slate-700">
              Gallery
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/orders">Shipping Policy</Link>
              </li>
              <li>
                <Link href="/profile">Terms of Service</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="flex overflow-hidden rounded-lg border border-slate-200 bg-white">
              ...
              <button
                suppressHydrationWarning
                type="button"
                className="bg-emerald-700 px-3 text-white"
